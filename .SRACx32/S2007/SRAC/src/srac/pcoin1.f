...
C
 ...
 1018 FORMAT(1H ,9X,'NOTE ---> NUMBER DENSITY OF ',2A4,1H(,2A4,1H),
     +' IS ZERO SET BECUASE OF IT''S LOW DENSITY(LESS THAN 1.0E-12)')
 1019 FORMAT(1H ,9X,'NOTE ---> NUMBER DENSITY OF ',2A4,1H(,2A4,1H),
     +' IS SET TO 1.0E-11 BECAUSE OF EFFECTIVE MICRO. X-SECTION CAL.')
C1020 FORMAT(1H ,5X,'WARNING ---> IRES OF ',2A4,1H(,2A4,1H),
C    +' IS RESET TO 2 BECAUSE THIS NUCLIDE HAS MCROSS LIBRARY ]] ')
C1021 FORMAT(1H ,5X,'WARNING ---> IRES OF ',2A4,1H(,2A4,1H),
C    +' IS RESET TO 0 BECAUSE THIS NUCLIDE HAS NO MCROSS LIBRARY ]] ')
 1020 FORMAT(1H ,9X,'NOTE ---> NUCLIDE ',2A4,1H(,2A4,1H),
     +' IS TREATED WITH PEACO BECAUSE IT HAS MCROSS LIBRARY')
 1021 FORMAT(1H ,9X,'NOTE ---> NUCLIDE ',2A4,1H(,2A4,1H),
     +' IS NOT TREATED WITH PEACO BECAUSE IT HAS NO MCROSS LIBRARY')
C
C
C
      DO 120 J=1,KCOMP
