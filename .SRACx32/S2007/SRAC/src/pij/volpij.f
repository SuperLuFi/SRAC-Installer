...
C
 ...
 9001 WRITE(NOUT1,9103)I
      STOP
 9103 FORMAT(' **** UNDEFINED REGION  ',I4,' FOUND IN VOLPIJ' )
CKUNI
C3006 FORMAT(10X,10HVOLUME OF ,A4,6HREGION/(10X,I3,1H),1PE11.4,I3,
C    *        1H),E11.4
C    1 ,I3,1H),E11.4,I3,1H),E11.4,I3,1H),E11.4,I3,1H),E11.4,I3,1H),E11.4
C    2,I3,1H),E11.4))
C
 3006 FORMAT(10X,10HVOLUME OF ,A4,'REGION'/
     1  (  5X , I4,')',1PE11.4,  I4,')',1PE11.4,  I4,')',1PE11.4,
     2          I4,')',1PE11.4,  I4,')',1PE11.4,  I4,')',1PE11.4,
     3          I4,')',1PE11.4,  I4,')',1PE11.4 ) )
C
      END
