CCNIO-VP-054 ***CITATION*** CALCULATES A(K64-K67)/ CF-IPTM
C
      SUBROUTINE CNIO(ISTEP,IVX,JVX,KBVX,KVX,IVXP1,JVXP1,KBVXP1,IVZ,KVZ,
CNN  & N3DDIM,LVX,NBLOCK,IOVX,IOVZ)
     & N3DDIM,LVX,NBLOCK,IOVX,IOVZ,MEMVP)
C
...
CNN   NSPACE=MEMVRY-K64-3*LVX-N1-NDR
      NSPACE=MEMVRY-K64-3*LVX-N1-NDR-MEMVP
...
C    THE STEP ON THE NEXT CARD IS FOR DOUBLE PRECISION
  ...
  103 CONTINUE
      ...
      K67=K63
      K68=K63+NDQ
CKSK  IF(ISTEP .NE. 1) WRITE(IOUT,1000)NT
      IF(ICRBN.EQ.0) THEN
      ...
      K68    = MAX0(K68,NLAST)
      RETURN
 1000 FORMAT(1H0'CORE STORAGE DIFFERENCE (WORDS) EQUATION CONSTANTS I/O
