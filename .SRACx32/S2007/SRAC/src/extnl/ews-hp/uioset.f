...
c     vrbose = .true. 
      ...
      mxunit = 48
c
cc    systems other than BSD UNIX : ex. HP(istder = 7)
cc    systems for that rewind is allowed only for already opened device,
cc    set ideft = 1 (ex. HP)
cc    in HP, maximum number of openable i/o devices is 48.
c 
