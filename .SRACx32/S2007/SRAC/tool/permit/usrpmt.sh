...
chmod $R_X $SRAC_DIR/lib/burnlibT/old
chmod $DAT $SRAC_DIR/lib/burnlibT/old/*
chmod $R_X $SRAC_DIR/lib/burnlibT/admin
chmod $DAT $SRAC_DIR/lib/burnlibT/admin/*
...
chmod $R_X $SRAC_DIR/src/inc/sracMax
chmod $DAT $SRAC_DIR/src/inc/sracMax/*
...
chmod $R__ $SRAC_DIR/tool/lmmake/*.sh
