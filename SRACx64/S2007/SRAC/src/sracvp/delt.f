...
C
      SUBROUTINE DELT (NR,III,S,U,X,P,MAT,SIG,LENG)
C
...
C
     ...
     1         IDUM2(25),IL
      ...
      DIMENSION LLL(512),L0(512),WEIGHT(514),WI1(512),U01(512)
     &         ,T1(512),T2(512),T3(512),T4(512),II(512),JJ(512)
     &         ,UI(512),IEND(512),JEND(512),ELM1(512)
C     INTEGRATION
      DO 100 J=1,NR+1
      DO 100 I=1,NR
      P(I,J)=0.
...
*                           ENDIF
      IF(U01(LINE).GT.6.0) JEND(LINE)=1
...
*     IF(UI(LINE).GT.0.003) THEN
      P (II(LINE),NR+1)=P (II(LINE),NR+1)+WI1(LINE)*(T3(LINE)-T4(LINE))
*                           ELSE
