CEIGN-VP-076 ***CITATION*** EIGENVALUE CALC. CONTROL/ CF-CALR
C
...
C
CNN
CKSK  DIMENSION WORK1(32000)
      DIMENSION WORK1(32*ZNEX)
CNN
...
CNN  &  MEMVRY,A(K64),IX3738,A(K62),A(K45),NCRP,NSPA, A(K18),A(K13),NVO)
...
CNN  &  , A(K45),NCRP,NSPA,A(K18),A(K13),NVO)
     &  , A(K45),NCRP,NSPA,A(K18),A(K13),NVO,A(KNRGN),WORK1)
  115 CONTINUE
