...
C
      INFORM(LOP)(1:40)=40H        O                   NO
      INFORM(LOP)(41:80) = 40H   NO
...
CKSK  INFORM(LOP)(12:18) = NMKEEP(LOP)(2:8)
      ...
      IF(ISWFT.EQ.1) INFORM(LOP)(29:31) =3HYES
      IF(IIRES.EQ.1) INFORM(LOP)(44:46) =3HYES
      IF(IIRES.EQ.-1)THEN
      INFORM(LOP)(21:40) = 30H  NO DATA IN FASTLIB
      INFORM(LOP)(51:80) = 30H
                     ENDIF
 1000 CONTINUE
C
C*******************
