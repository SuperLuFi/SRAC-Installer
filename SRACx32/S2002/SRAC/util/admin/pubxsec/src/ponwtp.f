C=======================================================================
      SUBROUTINE PONWTP( SUBNAM, IPDS, MEMBER, WORK, LENG, IPRN, IOUT )
C=======================================================================
C  ADD OR OVER-WRITE A MEMBER IN VPDS AND PDS
C  (USE FOR MEMBERS TO BE KEPT OR TO BE PROTECTED FROM ABNORMAL END)
C  WHEN VPDS IS NOT AVAILABLE, THE MEMBER WILL BE DELETED FROM VPDS AND
C  WILL BE WRITTEN IN PDS TO AVOID INCONSISTENCY OF MEMBERS IN VPDS
C  AND PDS. ( FOR PROTECT-WRITE, USE SEARCH & WRITE )
