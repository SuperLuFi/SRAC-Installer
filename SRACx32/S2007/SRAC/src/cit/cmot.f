...
C
      SUBROUTINE CMOT(ISTEP,NRGN ,NCOMP, IVX,JVX,LVX)
C
...
CKSK
  ...
  103 N1L = N2J+1
      ...
      N1J = N1J-40
  104 CONTINUE
  105 IF(IPRNT.EQ.1)WRITE(IOUT,1001)(J,J=N1L,N2J)
      IF(IPRNT.EQ.1)WRITE(IOUT,1002)
      DO 107 I = 1,IMAX
      DO 106 J = N1L,N2J
      L = NRGN (J,I)
      NXTR1(J) = NCOMP(L)
  106 CONTINUE
      IF(IPRNT.EQ.1)WRITE(IOUT,1003)I,(NXTR1(J),J= N1L,N2J)
  107 CONTINUE
      IF (IS1) 108,108,109
 ...
 1001 FORMAT(1H0,I8,39I3)
 1002 FORMAT(1H )
 1003 FORMAT(1H ,I3,I5,39I3)
      END
