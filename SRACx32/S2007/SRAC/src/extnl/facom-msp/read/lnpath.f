...
C
      ...
      IF(LINE(I:I).NE.' ') THEN
                           IPOS = I + 1
                           IF(LINE(I:I).EQ.'N') FLMODE = 8HNEW
                           IF(LINE(I:I).EQ.'O') FLMODE = 8HOLD
                           IF(LINE(I:I).EQ.'S') FLMODE = 8HSCRATCH
                           GO TO 70
                           ENDIF
   60 CONTINUE
      GO TO 100
...
C
      IF(LINE(IPOS:IPOS).EQ.'F') DATAKP = 8HFILE
      IF(LINE(IPOS:IPOS).EQ.'C') DATAKP = 8HCORE
C
  100 CONTINUE
