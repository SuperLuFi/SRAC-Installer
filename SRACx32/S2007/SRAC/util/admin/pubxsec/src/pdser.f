...
C-----------------------------------------------------------------------
C
      CHARACTER DIRNAM*120,MEMBER*8,SUBNAM*8
C
      IF(IRC.EQ.0) GOTO 9999
      IF(IRC.EQ.1) THEN
