CC
      SUBROUTINE SWEEP4(IT,JT,MM,IFLSW,
     1 FCENT,FANG1,FANG2,FEDGIP,FEDGIN,FEDGJP,FEDGJN,
     2 B1,YH,CTOT,COSMU,A1,COSETA,A3,A2,A4,AL1D,AL2D,QT4DDD,
...
*VOCL STMT,IF(40)
     ...
     1                 BB*FEDGJP(MK)+
     2                 CC*FANG1 (MK)+
     3                 QT4DDD(1,I,KD1,M))/(AA+BB+CC+CT)
C
 ...
 3100 CONTINUE
     ...
     4  ZZ,BB,CC,DD,
     5  FCENT (IFLMK(IFNO)),
     6  QT4DDD(1,IFIX(IFNO),JFIX(IFNO),MFIX(IFNO)),
     7  CT,AA,
     8  FEDGIN(IFLMK(IFNO)),
     9  FEDGJN(IFLMK(IFNO)),
     1  FANG2 (IFLMK(IFNO)))
 ...
 3600 DO 4100 M=1,MM
        DO 4100 K=1,LLL2
          IF(IFLSW(M,LSTA+K+NAE,L).EQ.1.OR.
     1       IFLSW(M,LSTA+K+NAE,L).EQ.2) THEN
