C2004 SUBROUTINE WWRITE (IOP,IF,ARRAY,IM,JM,KM,H1,H2,H3,H4)
      SUBROUTINE WWRITE (IOP,IF,ARRAY,IM,JM,KM,H1,H2,H3,H4,NCOMP)
C
C     PRINT ARRAYS
C
...
C2004
Cdel  REAL*8             HH1
Cdel  DIMENSION HH1(1), IHH1(2)
Cdel  EQUIVALENCE (IHH1(1),HH1(1))
Cend
C
CMSASA
...
C2004 IF ((IOP.EQ.4).OR.(IOP.EQ.5)) IH1 = CUT4(H1)
      IF ((IOP.EQ.4).OR.(IOP.EQ.5)) IH1 = NCOMP
Cend
C
