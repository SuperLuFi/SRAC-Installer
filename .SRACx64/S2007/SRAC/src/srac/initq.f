...
C
  180 T=NORM/QG(IGP)
      ...
      WRITE (NOUT,270)G
       XTEMP = DFLOAT(NMQ)
C2004
Cmod   CALL WWRITE(4,2,Q,NM,IT,JT,XTEMP,'      ','      ',
Cmod &NXYZ01(IGEOM))
       CALL WWRITE(4,2,Q,NM,IT,JT,'      ','      ','      ',
     &             NXYZ01(IGEOM) , NMQ )
Cend
  190 IF (IQR.EQ.0) GO TO 200
      IF (I5.NE.0) GO TO 200
      WRITE (NOUT,250)G
C2004 CALL WWRITE (2,2,QR1,JT,MM,1,'NORMAL','.RBY1 ','SOURCE','DIRECT')
C2004 CALL WWRITE (2,2,QR2,JT,MM,1,'NORMAL',',RBY2 ','SOURCE','DIRECT')
...
Cend
  200 IF (IQB.EQ.0) GO TO 210
      ...
      WRITE (NOUT,250)G
C2004 CALL WWRITE (2,2,QB1,IT,MM,1,'NORMAL','BTBY1 ','SOURCE','DIRECT')
C2004 CALL WWRITE (2,2,QB2,IT,MM,1,'NORMAL','BTBY2 ','SOURCE','DIRECT')
...
Cend
  210 IF (IQT.EQ.0) GO TO 220
      ...
      WRITE (NOUT,250)G
C2004 CALL WWRITE (2,2,QT1,IT,MM,1,'NORMAL',',TBY1 ','SOURCE','DIRECT')
C2004 CALL WWRITE (2,2,QT2,IT,MM,1,'NORMAL',',TBY2 ','SOURCE','DIRECT')
