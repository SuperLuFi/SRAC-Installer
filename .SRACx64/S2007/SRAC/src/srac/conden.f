...
CKUNI DIMENSION       MATD(1),NISO(1),ICARR(150),WT1(107),WX1(107)
      DIMENSION       MATD(1),NISO(1),           WT1(107),WX1(107)
      DIMENSION       ICARR(MAXMAT)
C
...
C     END CONTA002
C
CKUNI CALL ICLEA (ICARR,150,0)
CKUNI IF(NMAT.GT.150) GO TO 9010
C
      IF(NMAT.GT.MAXMAT) GO TO 9010
      CALL ICLEA (ICARR,MAXMAT,0)
CEND
C
      IF (NM.GT.0) THEN
                   DO 30 MNO = 1,NM
...
C
CKUNI
C9010 WRITE(NOUT1,9020) NMAT
 9010 WRITE(NOUT1,9020) NMAT,MAXMAT
      STOP
C9020 FORMAT(1H0,' WORK DIMENSION OVERFLOW AT SUBR(CONDEN) !!! ',
 9020 FORMAT(1H0,' WORK DIMENSION OVERFLOW AT SUBR(CONDEN) !!! ',
     +      /1H ,' NMAT(',I3,') IS GREATER THAN ',I4,' . ')
CEND
      END
