CKDUE-VP-119 ***CITATION*** RESIDUE CALC. FOR 3-D/ CF-KLUX
C
...
C     CONTINUE
  ...
  109 CONTINUE
      ...
      IF( IX(24).NE.0 ) THEN
        DO 110 KK=1,KVX
  110     TT5=TT5+SCAC(K,M,KK)*P2E(N1,KB,KK)
        ELSE
        DO 112 KK=1,KVX
  112     TT5=TT5+SCAC(KK,M,K)*P2E(N1,KB,KK)
      ENDIF
  ...
  117 IF (J.NE.JMAX) GO TO 121
      P2EUR = 0.0
CHH
CHH   GO TO (121,118,119,120),INRB
      IF(INRB.NE.1) THEN
        IF(INRB-3) 118,119,120
  118   CONTINUE
        N11 = NN1 + 1
        P2EUR = P2E(N11,KB,K)
        GO TO 321
